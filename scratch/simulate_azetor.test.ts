...
describe('Simulate Azetor 20 message extraction and auto-escalation', () => {
  test('Extraction and escalation flow', async () => {
    ...
    try {
      ...
      // 6. Print mocked send message calls
      console.log('--- Mock WhatsApp sendMessage calls ---');
      console.log(mockSendMessage.mock.calls);
